    ...
    <div class="m-4 flex flex-col md:flex-row gap-6">
        <div class="flex-1">
            <div class="relative m-1">
                <label
                    class="flex flex-col items-center px-4 py-4 bg-white text-blue-500 rounded-lg shadow-lg tracking-wide uppercase border border-blue-500 cursor-pointer hover:bg-blue-500 hover:text-white transition duration-300">
                    <svg class="w-8 h-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path
                            d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98 4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1zM11 11h3l-4-4-4 4h3v3h2v-3z" />
                    </svg>
                    <span class="mt-2 text-base leading-normal">上传图片</span>
                    <input type="file" id="imageUpload" @change="handleFileUpload" class="hidden"
                        accept="image/*,.dng,.cr2,.nef,.arw" />
                    <span class="text-gray-500 text-xs mt-1">支持格式: JPEG, PNG, TIFF, DNG, CR2, NEF, ARW</span>
                </label>
            </div>
            <!--div class="flex">
